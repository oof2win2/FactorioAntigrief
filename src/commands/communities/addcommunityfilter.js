...
class AddCommunityFilter extends Command {
	...
	async run(message, args, config) {
		...
		if (!communities.length) return message.channel.send("No valid or non-duplicate communities to be added")
		...
		const confirm = await getConfirmationMessage(message, "Are you sure you want to add these communities to your communities filters?")
