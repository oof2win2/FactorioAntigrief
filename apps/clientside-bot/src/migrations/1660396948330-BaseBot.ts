...
export class BaseBot1660396948330 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`CREATE TABLE "FDGLBan" ("id" text(6) PRIMARY KEY NOT NULL, "playername" text(60) NOT NULL, "categoryId" text(6) NOT NULL, "communityId" text(6) NOT NULL)`
		)
		await queryRunner.query(
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`DROP TABLE "FDGLBan"`)
